...
import { ThemeTogglerButton } from "./styles.js";
...
const App = () => {
  ...
  //   Save condition data to local storage
  useEffect(() => {
  ...
  return (
    <ThemeProvider theme={theme === "light" ? lightTheme : darkTheme}>
      ...
      <ThemeTogglerButton className="themeModeToggler" onClick={ThemeToggler}>
        {theme === "dark" ? <>☀️</> : <>🌙</>}
      </ThemeTogglerButton>
          ...
          element={
            <Container>
              ...
              {DATASET.filter((value) => {
                if (
                  value.toLowerCase().includes(condition.toLocaleLowerCase())
                ) {
                  return value;
                }
                return false;
